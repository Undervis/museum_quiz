...
<template>
  <section class="d-flex flex-column gap-2 card card-body rounded-4"
           :class="{'border-dark border-1' : $router.currentRoute.value.hash === '#general'}">
    <div class="hstack">
    ...
    <div class="form-floating">
      <textarea type="" style="height: 100px" placeholder="" class="form-control"
                v-model="quiz_data.description"></textarea>
