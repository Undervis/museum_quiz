...
<template>
  ...
  <span v-if="!temp_img && !question.answers.puzzle.img" class="alert mb-2 alert-info p-2 text-center">
    Изображение отсутствует
  </span>
  <span v-else-if="temp_img" class="alert mb-2 alert-warning p-2 text-center">
    Сохраните загруженное изображение!
  </span>
  <span v-else-if="question.answers.puzzle.img" class="alert mb-2 alert-success p-2 text-center">
